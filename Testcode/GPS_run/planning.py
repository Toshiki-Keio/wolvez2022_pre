...
def decide_behavior(direction_real, target_azimuth, phi, MotorR, MotorL, bno055):
    bno055.bnoread()
...
def planning(risk, MotorR, MotorL, bno055, gps):
    ...
    while count < 10:
        ...
        datalog ="Time:" + str(gps.Time) + ","\
                    ...
                    + "経度:" + str(gps.Lon)
        print(datalog)
        gps_dictionary = gps.vincenty_inverse(gps.Lat,gps.Lon,goal_position[0],goal_position[1])
        ...
        if np.amin(lower_risk) >= threshold_risk:
            ...
            direction_real = 3
            decide_behavior(direction_real, theta_goal, phi, MotorR, MotorL, bno055)
